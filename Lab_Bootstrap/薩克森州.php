...
<h1>薩克森州</h1>
	...
	<div id="A1" class="A1">
			...
			<ul id="sb-slider" class="sb-slider">
					<li>
						<img src="images/22.jpg"/></a>
							<div class="sb-description" >
							<h3>Schloβ Neuschwanstein</h3>
						</div>
					</li>
					<li>
						<img src="images/23.jpg"/></a>
						<div class="sb-description" >
							<h3>Moritzburg</h3>
						</div>
					</li>
					<li>
						<img src="images/24.jpg"/></a>
						<div class="sb-description" >
							<h3>Militärhistorisches Museum der Bundeswehr</h3>
						</div>
								</li>
					<li>
						<img src="images/25.jpg"/></a>
						<div class="sb-description" >
							<h3>Saarbrücken</h3>
						</div>
					</li>
					<li>
						<img src="images/26.jpg"/></a>
						<div class="sb-description" >
							<h3>Schloβ Neuschwanstein</h3>
						</div>
					</li>
					<li>
						<img src="images/27.jpg"/></a>
						<div class="sb-description" >
							<h3>Dreikönigskirche</h3>
						</div>
					</li>
					<li>
					<img src="images/28.jpg"/></a>
					<div class="sb-description" >
							<h3>St. Francis of Assisi Church</h3>
						</div>
					</li>
				</ul>
      ...
      <div id="shadow" class="shadow"></div>
		...
		<script src="js/Slicebox4.js"></script><!-- 圖片特效管理 -->
